...
class ControllerPaymentMolpay extends Controller {
    ...
    protected function index() {
        ...
        $this->data['returnurl'] = HTTPS_SERVER.'index.php?route=payment/molpay/callback';
        ...
        $this->model_checkout_order->confirm($this->data['orderid'], $this->config->get('molpay_order_status_id'), 'Create Order', false);
    }
